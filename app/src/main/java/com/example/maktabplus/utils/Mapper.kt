...
object Mapper {
    ...
    fun jsonToGenre(jsonObject: JsonObject): Genre {
        return Genre(
    ...
    fun jsonToMovieDetailWithGenres(jsonObject: JsonObject): MovieDetailWithGenres {
        return MovieDetailWithGenres(
            detail = jsonToMovieDetail(jsonObject),
            genres = jsonObject["genres"].asJsonArray.map {
                jsonToGenre(it.asJsonObject)
            }
        )
    }
}
